<div>
    ...
    <div class="p-6 pt-3 flex items-center gap-4 border-b border-base-200">
        ...
        <div>
            <div class="font-black text-xl tracking-tighter text-base-content">NCIE Hub</div>
            <div class="text-[10px] uppercase font-bold text-base-content/40 tracking-widest">Innovation Labs</div>
        </div>
    </div>
